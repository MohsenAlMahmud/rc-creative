    ...
    return (
        <div className="p-10">
            ...
            <div className="flex gap-10">
                <div className="w-1/2">
                    <div className=" py-10" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                    ...
                    <div className=" py-10" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2500">
                    ...
                    <div className=" py-10" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="3000">
                ...
                <div className="w-1/2">
                    <div className=" py-10" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500">
                    ...
                    <div className=" py-10" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2500">
                    ...
                    <div className=" py-10" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="3000">
